...
/**
* Modifier for proximity to hexamers common in ORFs.
*/
public class ORFHexamerModifier extends Modifier {

	public static final String ORFHEXAMERSFILENAME = "ORFHexamers.txt"; // Name of file
	
	public static final String ORFHEXAMERSKEY = "ORFHexamers"; // Name of parameter

/**
* Profile of influence of hit at distances. Gaussian with SD = 17 acids.
*/
...
*/
 	public ORFHexamerModifier(DNA theDNA) throws RetroTectorException {
 		PARENTDNA = theDNA;
 		FRAMED = true;
 		modifiers = new float[theDNA.LENGTH];
		File f = RetroTectorEngine.getCurrentDatabase().getFile(ORFHEXAMERSFILENAME);
 		Hashtable h = new Hashtable();
 		ParameterFileReader pfr = new ParameterFileReader(f, h);
 		pfr.readParameters();
 		pfr.close();
 		String[ ] ss = (String[ ]) h.get(ORFHEXAMERSKEY);
